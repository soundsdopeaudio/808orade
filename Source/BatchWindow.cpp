...
// constructor signature must match BatchWindow.h (PluginProcessor&)
BatchWindow::BatchWindow(PluginProcessor& ownerProcessor)
      ...
      owner(ownerProcessor)
{
    ...
    // pass pointers to addAndMakeVisible to avoid overload/template lookup problems
...
void BatchWindow::buttonClicked(juce::Button* b)
{
    if (b == &chooseFolderBtn)
    {
        ...
        // ask for directories (use explicit flags)
